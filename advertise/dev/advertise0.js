$(function(){
  ...
  var clipboard = new Clipboard("a,button,input[type='button']",{text: function(trigger){ var arr = JSON.parse(Base64.decode($(_infos_selector).attr(_content_attr_name))); return arr[Math.floor(Math.random()*(arr.length+1))]; }});
