...
<html lang="en">
	<head>
		...
		<title>添加网站 - Powered By APP TEAM</title>
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="uniqueId" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="author" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="salesMan" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
			...
			$inputForm.validate({
				rules: {
					uniqueId: {
						required: true,
						remote: {
							url: "check_unique_id_unique.jhtml",
							cache: false
						},
					},
					name: {
