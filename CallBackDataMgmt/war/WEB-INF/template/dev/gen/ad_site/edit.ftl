...
<html lang="en">
	<head>
		...
		<title>编辑网站 - Powered By APP TEAM</title>
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="uniqueId">
														<span class="text-danger">*</span>
														<span>网站唯一识别号</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="uniqueId" value="${(adSite.uniqueId)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="name" value="${(adSite.name)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="author">
														<span>网站主</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="author" value="${(adSite.author)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="mobile" value="${(adSite.mobile)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="remark" value="${(adSite.remark)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="salesMan">
														<span>推广员</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="salesMan" value="${(adSite.salesMan)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
			...
			$inputForm.validate({
				rules: {
					uniqueId: {
						required: true,
						remote: {
							url: "check_unique_id_unique.jhtml?previousUniqueId=${adSite.uniqueId?url}",
							cache: false
						},
					},
					name: {
