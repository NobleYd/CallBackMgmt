...
<html lang="en">
	<head>
		...
		<title>网站列表 - Powered By APP TEAM</title>
								...
								<div class="btn-group btn-corner pull-right">
									<div class="btn-group">
									    ...
									    <ul id="searchPropertyOption" class="dropdown-menu dropdown-info">
											<li [#if page.searchProperty == "uniqueId" ] class="active" [/#if] val="uniqueId" >
												<a href="javascript:;" >网站唯一识别号</a>
											</li>
											<li [#if page.searchProperty == "name" ] class="active" [/#if] val="name" >
												<a href="javascript:;" >网站名称</a>
											</li>
											<li [#if page.searchProperty == "author" ] class="active" [/#if] val="author" >
												<a href="javascript:;" >网站主</a>
											</li>
									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<a href="javascript:;" class="sort" name="uniqueId">
														网站唯一识别号
												...
												<th>
													<a href="javascript:;" class="sort" name="author">
														网站主
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
												...
												<th>
													<a href="javascript:;" class="sort" name="salesMan">
														推广员
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
										...
										<tbody>
										[#list page.content as adSite ]
											<tr>
												<td class="center">
													<label class="pos-rel">
														<input type="checkbox" name="ids" class="ace" value="${adSite.id}" />
														<span class="lbl"></span>
													</label>
												</td>
												<td>				
												...
												<td>				
													<span name="mobile">${(adSite.mobile)!}</span>
												</td>
												<td>				
													<span name="remark">${(adSite.remark)!}</span>
												</td>
												<td>				
													<span name="salesMan">${(adSite.salesMan)!}</span>
												</td>
												<td>				
													<span name="salesMan">${(adSite.ipCount)!}</span>
												</td>
												<td>				
												...
												<td>
													...
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="edit.jhtml?id=${adSite.id}" >
															<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
															<span>${message("admin.common.edit")}</span>
														</a>
														<a href="javascript:void(0);" class="deleteButton btn btn-xs btn-danger" ids="${adSite.id}" >
															<i class="ace-icon fa fa-trash-o bigger-120"></i>
															<span>${message("admin.common.delete")}</span>
														</a>
														<a class="btn btn-xs btn-info" href="stats.jhtml?id=${adSite.id}" >
															<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
															<span>统计IP复制数量</span>
														</a>
													</div>
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="edit.jhtml?id=${adSite.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																			<span>${message("admin.common.edit")}</span>
																		</span>
																...
																<li>
																	<a href="javascript:void(0);" class="deleteButton tooltip-error" ids="${adSite.id}" data-rel="tooltip" title="Delete">
																		<span class="red">
																			<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			<span>${message("admin.common.delete")}</span>
																		</span>
																...
																<li>
																	<a href="stats.jhtml?id=${adSite.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																			<span>统计IP复制数量</span>
																		</span>
