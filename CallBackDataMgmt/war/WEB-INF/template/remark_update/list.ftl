...
<html lang="en">
	<head>
		...
		<title>批量修改备注列表 - Powered By APP TEAM</title>
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			[#assign menu="devGroup" subMenu="remarkUpdate" ]
									...
									<table id="listTable" class="list table table-bordered table-hover">
										<thead>
											<tr>
												...
												<th>
													<a href="javascript:;" class="sort" name="userNames">
														userNames
														<i class="glyphicon pull-right"></i>
													</a>
												</th>
										...
										<tbody>
										[#list page.content as remarkUpdate ]
											<tr>
												<td class="center">
													<label class="pos-rel">
														<input type="checkbox" name="ids" class="ace" value="${remarkUpdate.id}" />
														<span class="lbl"></span>
													</label>
												</td>
												<td>				
													<span name="ad">${(remarkUpdate.ad)!}</span>
												</td>
												<td>				
													<span name="remark">${(remarkUpdate.remark)!}</span>
												</td>
												<td>				
													<span name="userNames">${(remarkUpdate.userNames)!}</span>
												</td>
												<td>
													<!-- 大型ui -->
													<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-info" href="edit.jhtml?id=${remarkUpdate.id}" >
															<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
															<span>${message("admin.common.edit")}</span>
														</a>
														<a href="javascript:void(0);" class="deleteButton btn btn-xs btn-danger" ids="${remarkUpdate.id}" >
															<i class="ace-icon fa fa-trash-o bigger-120"></i>
															<span>${message("admin.common.delete")}</span>
														</a>
														<a href="${base}/remark_update/executeUpdate.jhtml?id=${remarkUpdate.id}" class="btn btn-xs btn-success" >
															<span>执行Remark更新</span>
														</a>
													</div>
													<!-- 小型ui -->
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="edit.jhtml?id=${remarkUpdate.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																		<span class="blue">
																			<i class="ace-icon fa fa-pencil-square-o bigger-120"></i>
																			<span>${message("admin.common.edit")}</span>
																		</span>
																...
																<li>
																	<a href="javascript:void(0);" class="deleteButton tooltip-error" ids="${remarkUpdate.id}" data-rel="tooltip" title="Delete">
																		<span class="red">
																			<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			<span>${message("admin.common.delete")}</span>
																		</span>
																...
																<li>
																	<a href="${base}/remark_update/executeUpdate.jhtml?id=${remarkUpdate.id}" class="tooltip-error" data-rel="tooltip" title="Update">
																		<span class="green">
																			<span>执行Remark更新</span>
																		</span>
																	</a>
