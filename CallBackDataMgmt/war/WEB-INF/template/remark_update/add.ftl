...
<html lang="en">
	<head>
		...
		<title>添加批量修改备注 - Powered By APP TEAM</title>
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="ad" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="userNames" type="text" class="col-xs-8 col-sm-8" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<textarea name="remark" type="text" class="col-xs-8 col-sm-8" style="height:200px;"></textarea>
														</div>
													</div>
												</div>
