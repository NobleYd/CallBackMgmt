...
<html lang="en">
	<head>
		...
		<title>编辑批量修改备注 - Powered By APP TEAM</title>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<form id="inputForm" action="update.jhtml" class="form-horizontal" role="form" method="post"  >
							<!-- 实体ID隐藏域 -->
							<input type="hidden" name="id" value="${remarkUpdate.id}" />
							<div class="row">
								<div class="col-xs-12">
									<div class="tabbable">
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="ad" value="${(remarkUpdate.ad)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="userNames">
														<span>userNames</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="userNames" value="${(remarkUpdate.userNames)!}" type="text" class="col-xs-8 col-sm-8" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<textarea name="remark" type="text" class="col-xs-8 col-sm-8" style="height:200px;">${(remarkUpdate.remark)!}</textarea>
														</div>
													</div>
												</div>
