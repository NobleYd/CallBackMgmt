...
<html lang="en">
	<head>
		...
		<title>游戏列表 - Powered By APP TEAM</title>
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			[#assign menu="devGroup" subMenu="adList" ]
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<table id="listTable" class="list table table-bordered table-hover">
										...
										<tbody>
										[#list page as callBackData ]
											<tr id="${callBackData.id}" title="${callBackData.id}">
												<td>				
													<a target="_blank" href="${base}/call_back_data/list.jhtml?ad=${(callBackData[0].ad)!}">
													<span name="ad">${(callBackData[0].ad)!}</span>
													</a>
												</td>
												<td>				
													<span name="createDate">${(callBackData[0].createDate?string("yyyy-MM-dd HH:mm:ss"))!}</span>
												</td>
												<td>				
													<span name="createDate">${(callBackData[1])!}</span>
												</td>
												<td>				
													<a title="attachment" href="${base}/ad/delete.jhtml?ad=${callBackData[0].ad}" >删除</a>
													
													<a title="attachment" href="${base}/ad/download.jhtml?ad=${callBackData[0].ad}" target="_blank" >查看/下载</a>
