...
<html lang="en">
	<head>
		...
		<title>上传列表 - Powered By APP TEAM</title>
											...
											<tr>
												...
												<td>
													...
													<div class="hidden-sm hidden-xs btn-group">
														<a href="javascript:void(0);" class="deleteButton btn btn-xs btn-danger" ids="${content.id}" >
													...
													<div class="hidden-md hidden-lg">
														<div class="inline pos-rel">
															...
															<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																<li>
																	<a href="javascript:void(0);" class="deleteButton tooltip-error" ids="${content.id}" data-rel="tooltip" title="Delete">
																		<span class="red">
																			<i class="ace-icon fa fa-trash-o bigger-120"></i>
																			<span>${message("admin.common.delete")}</span>
																		</span>
