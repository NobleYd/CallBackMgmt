...
<html lang="en">
	<head>
		...
		<title>编辑脚本 - Powered By APP TEAM</title>
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="name" value="${(script.name)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<a href="${(script.attachment)!}" class="btn btn-info btn-xs" target="_blank">${message("admin.common.view")}</a>
													</div>
												</div>
