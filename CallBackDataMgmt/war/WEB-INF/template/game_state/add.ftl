...
<html lang="en">
	<head>
		...
		<title>添加游戏状态 - Powered By APP TEAM</title>
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="gameName" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="recordDate" name="recordDate" class="Wdate col-xs-10 col-sm-5" onfocus="WdatePicker()" maxlength="100" />			
														</div>
													</div>
												</div>
