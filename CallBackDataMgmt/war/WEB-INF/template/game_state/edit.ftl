...
<html lang="en">
	<head>
		...
		<title>编辑游戏状态 - Powered By APP TEAM</title>
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			[#assign menu="devGroup" subMenu="gameState" ]
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<form id="inputForm" action="update.jhtml" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" >
							<!-- 实体ID隐藏域 -->
							<input type="hidden" name="id" value="${gameState.id}" />
							<div class="row">
								<div class="col-xs-12">
									<div class="tabbable">
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="gameName">
														<span class="text-danger">*</span>
														<span>游戏名称</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="gameName" value="${(gameState.gameName)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="title" value="${(gameState.title)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														...
														<a href="${(gameState.picture)!}" class="btn btn-info btn-xs" target="_blank">${message("admin.common.view")}</a>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="recordDate">
														<span class="text-danger">*</span>
														<span>添加时间</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input type="text" id="recordDate" name="recordDate" value="${(gameState.recordDate)!}" class="Wdate col-xs-10 col-sm-5" onfocus="WdatePicker()" maxlength="100" />			
														</div>
													</div>
												</div>
