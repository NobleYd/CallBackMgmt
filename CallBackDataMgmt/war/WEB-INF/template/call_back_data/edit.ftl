...
<html lang="en">
	<head>
		...
		<title>编辑回调 - Powered By APP TEAM</title>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<form id="inputForm" action="update.jhtml" class="form-horizontal" role="form" method="post"  >
							<!-- 实体ID隐藏域 -->
							<input type="hidden" name="id" value="${callBackData.id}" />
							<div class="row">
								<div class="col-xs-12">
									<div class="tabbable">
									    ...
									    <div class="tab-content">
									        <div id="base" class="tab-pane active">
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="idfa">
														<span>设备名称</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="idfa" value="${(callBackData.idfa)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="ad">
														<span>游戏</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="ad" value="${(callBackData.ad)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="adIndex">
														<span>索引</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="adIndex" value="${(callBackData.adIndex)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="clientIp">
														<span>点击IP</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="clientIp" value="${(callBackData.clientIp)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="createDate">
														<span>点击时间</span>:
													</label>
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="createDate" value="${(callBackData.createDate)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="userName" value="${(callBackData.userName)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="password" value="${(callBackData.password)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-9">
														<div class="clearfix">
															<input name="remark" value="${(callBackData.remark)!}" type="text" class="col-xs-10 col-sm-5" />
														</div>
													</div>
												</div>
